...
fall_agg=spark.read.csv('NearFalls15.csv',header = True)
...
temp=temp.rstrip(",")
#fall_agg=fall_agg.drop('id_f')
#for col in fall_agg.schema.names:
#	print(col)
...
fall_agg.write.csv("Near_Fall_Agg_15.csv",header=True,sep=',')
