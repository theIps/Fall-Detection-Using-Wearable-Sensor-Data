...
fall_dataset.write.csv("Classification3Dataset15.csv",header=True,sep=',')
nonfall_dataset.write.csv("Classification3Dataset15.csv",mode="append",header=True,sep=',')
adl_dataset.write.csv("Classification3Dataset15.csv", mode="append",header=True,sep=',')
